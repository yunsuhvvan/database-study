...
--9. 최대 연봉 사원의 employee_id , first_name , salary 를 조회하시오
--ROWNUM 활용

--1)높은 연봉이 가장 위로 오도록 정렬한다.
...
--10. 연봉 TOP 11~20 사원의 employee_id , first_name , salary 를 조회하시오
--ROWNUM 활용
--1)높은 연봉이 가장 위로 오도록 정렬한다.
--2) 정렬 결과에 ROWNUM 칼럼을 추가한다. 반드시 칼럼에 별명을 부여한다.
